...
from sqlalchemy import TIMESTAMP, Column, String, Boolean, Date, INTEGER, ForeignKey, Table, Text, CLOB, Integer, \
    Sequence, Float, FLOAT, Sequence, Float, alias, Table, MetaData
...
class OwnershipGrowerGrowing(Base):
    ...
    total_ship = Column(Integer(), nullable=True)
